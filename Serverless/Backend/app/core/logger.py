"""
Advanced logging utility for LoRA Dashboard Backend
Saves request/response data to files for debugging
"""
...
class RequestResponseLogger:
    """Enhanced logger for request/response debugging"""
    ...
    def log_request(self, 
        ...
        self.app_logger.info(f"📥 REQUEST | {request_type} | {endpoint} | ID: {log_entry['request_id']}")
